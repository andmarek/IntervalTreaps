...
import static org.junit.Assert.*;
    ...
    public class IntervalTreapTest4
    {
        // File paths to input files from Piazza
        private static String smallPath = "src/small_1.txt";
        private static String mediumPath = "src/medium_1.txt";
        //private static String largePath = "src/large_1.txt";
        ...
        private void _testStructureRecursive(Node x)
        {
            if (x != null)
            {
                if (x.getLeft() != null)
                {
                    ...
                    assertTrue(x.getLeft().getKey() < x.getKey());
                    assertTrue(x.getLeft().getiMax() <= x.getiMax());
                    //assertTrue(x.getLeft().getH() < x.getHeight());
                }

                if (x.getRight() != null)
                {
                    assertTrue(x.getRight().getPriority() > x.getPriority());
                    assertTrue(x.getRight().getKey() >= x.getKey());
...
//                largeTreap.intervalInsert(n);
        ...
        public void _testSmallInput()
        {
            ...
            for (Interval i : smallPositives)
            {
                ...
                assertTrue(n.getInterv().doesOverlap(i));
            }
...
//            {
//                assertTrue(inOrderNodes.get(i - 1).getKey() <= inOrderNodes.get(i).getKey());
//            }
//        }
...
//            for (int i = 1; i < inOrderNodes.size(); i++)
//            {
//                assertTrue(inOrderNodes.get(i - 1).key() <= inOrderNodes.get(i).key());
//            }
//        }
...
//        {
//            Node minimum = smallTreap.g();
//            int min = smallTreap.getRoot().key();
//            for (Node n : smallNodes)
//            {
//                assertTrue(n.key() >= minimum.key());
//                min = Math.min(min, n.key());
//            }
//
//            assertEquals(minimum.key(), min);
//        }
        ...
        public void _testInterval()
        {
            ...
            assertFalse(interval.doesOverlap(i1));
            assertTrue(interval.doesOverlap(i2));
            assertTrue(interval.doesOverlap(i3));
            assertFalse(interval.doesOverlap(i4));
        }
